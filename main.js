...
//     let uzunlik = matn.replace(/\s/g, '').length; 
//     alert("Matnda " + uzunlik + " ta harf bor.");
// }


// harflarSoni("MARS IT SCHOOL");
...
// Javob:Kodini yozib bering
// let harflar = ["a" , "b" , "d" , "e" , "f" , "g" , "h" , "i" , "j" , "k" , "l" , "m" , "n" , "o" , "p" , "q" , "r" , "s" , "t",  "u" , "v" , "x" , "y" , "z"]
// let ism = [harflar[11], harflar[0], harflar[6], harflar[0]];
